...
function wishme(){
    ...
    if(hours>=0 && hours<12){
        speak("Selamat pagi Mas-Mas dan Mba-Mba yang cantik dan ganteng, sebelumnya saya ingin memperkenalkan diri nama saya fira asisten virtual anda. saya di program atau dibuat oleh Mr.Muhammad Arif Triyana")
    } else if(hours>=12 && hours<16){
        speak("Selamat siang Mas-Mas dan Mba-Mba yang cantik dan ganteng, sebelumnya saya ingin memperkenalkan diri nama saya fira asisten virtual anda. saya di program atau dibuat oleh Mr.Muhammad Arif Triyana")
    } else {
        speak("Selamat malam Mas-Mas dan Mba-Mba yang cantik dan ganteng, sebelumnya saya ingin memperkenalkan diri nama saya fira asisten virtual anda. saya di program atau dibuat oleh Mr.Muhammad Arif Triyana")
    }
}
